...
class SoundFile():
    ...
    def composite(imagefunction,params,parentclass,keyframe):
...
class Unholy():
    ...
    def oncreated(image, params, parentclass, keyframe):
        img,size = image.function().image(image.params,parentclass)
    ...
    def onupdate(self,params,image,parentclass,keyframe):
        img = image.function().image(image.params,parentclass)
        params.params.width = int(img.size[0]*params.params.relativewidth/100)
        params.params.height = int(img.size[1]*params.params.relativeheight/100)
