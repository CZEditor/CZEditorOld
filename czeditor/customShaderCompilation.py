...
from OpenGL._bytes import as_8_bit, bytes, unicode
from OpenGL.extensions import alternate
from OpenGL.GL.ARB import (fragment_shader, geometry_shader4,
                           get_program_binary, separate_shader_objects,
                           shader_objects, vertex_program, vertex_shader)
...
glGetAttachedShaders = alternate(
    GL.glGetAttachedShaders, shader_objects.glGetAttachedObjectsARB)

glGetProgramInfoLog = alternate(
    GL.glGetProgramInfoLog, shader_objects.glGetInfoLogARB)
glGetShaderInfoLog = alternate(
    GL.glGetShaderInfoLog, shader_objects.glGetInfoLogARB)

glGetShaderiv = alternate(
    GL.glGetShaderiv, shader_objects.glGetObjectParameterivARB)
glGetProgramiv = alternate(
    GL.glGetProgramiv, shader_objects.glGetObjectParameterivARB)
...
class ShaderProgram(int):
    ...
    def retrieve(self):
        ...
        from OpenGL.raw.GL._types import GLenum, GLint
        size = GLint()
