...
class TimelineDurationHandleItem(QGraphicsItem):
    def __init__(self,params,windowClass,keyframe):
        ...
        self.windowClass = windowClass
        self.keyframe = keyframe
        self.setPos(self.keyframe.frame+self.params.params.duration(),0)
    ...
    def mouseMoveEvent(self, event: QGraphicsSceneMouseEvent):
        scenepos = event.scenePos().toPoint()
        self.params.params.duration.set(max(0,min(self.params.params.secrets().maxduration,scenepos.x()-self.keyframe.frame)))
        self.setPos(self.keyframe.frame+self.params.params.duration(),0)
        event.accept()
...
class TimelineStartFrameHandleItem(QGraphicsItem):
    ...
    def mouseMoveEvent(self, event: QGraphicsSceneMouseEvent):
        scenepos = event.scenePos().toPoint()
        self.params.params.duration.set(min(self.params.params.secrets().maxduration,self.params.params.duration()-scenepos.x()+self.keyframe.frame))
