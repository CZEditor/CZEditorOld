...
class TimelineDurationLineItem(QGraphicsItem):
    ...
    def mousePressEvent(self, event: QGraphicsSceneMouseEvent) -> None:
        ...
        self.windowClass.createKeyframe(Keyframe(scenepos.x(),self.keyframe.layer,self.keyframe.params.copy()))
...
class TimelineDurationHandleItem(QGraphicsItem):
    def __init__(self,params,windowClass,keyframe):
        ...
        self.windowClass = windowClass
        self.keyframe = keyframe
        self.setPos(self.keyframe.frame+self.params.params.duration(),-self.keyframe.layer*25+self.params.params.transient().handleHeight)
    ...
    def mouseMoveEvent(self, event: QGraphicsSceneMouseEvent):
        scenepos = event.scenePos().toPoint()
        self.params.params.duration.set(max(1,min(self.params.params.transient().maxduration-self.params.params.startframe(),scenepos.x()-self.keyframe.frame)))
...
class TimelineStartFrameHandleItem(QGraphicsItem):
    ...
    def mouseMoveEvent(self, event: QGraphicsSceneMouseEvent):
        ...
        self.windowClass.timeline.keyframes[self.keyframe].setPos(clampedpos,-self.keyframe.layer*25)
        self.params.params.transient().handleHeight = scenepos.y()+self.keyframe.layer*25
        self.setPos(clampedpos,-self.keyframe.layer*25+self.params.params.transient().handleHeight)
        event.accept()
